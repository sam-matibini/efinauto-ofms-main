...
<body>
  ...
  const handleSavePDF = async () => {
    ...
    try {
      ...
      toast.success("PDF saved to cloud! You can now share via email or WhatsApp.");
      return file_url;
    } catch (error) {
