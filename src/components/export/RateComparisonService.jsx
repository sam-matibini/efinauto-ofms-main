...
export const RateComparisonService = {
  ...
  async getCarrierRate(service, carrierCode, details) {
    ...
    return {
      ...
      estimated_departure: details.departure_date || new Date(Date.now() + 10 * 24 * 60 * 60 * 1000).toISOString(),
      estimated_arrival: new Date(Date.now() + (10 + transitTime) * 24 * 60 * 60 * 1000).toISOString(),
